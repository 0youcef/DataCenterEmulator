...
# --- NEW: Lists to hold Loopbacks for the Overlay ---
spine_loopbacks = []
leaf_loopbacks = []
...
for i in range(NUM_SPINES):
    for j in range(NUM_LEAVES):
        ...
        leaf_fabric[j].append({
            ...
            "peer_asn":  SPINE_AS_BASE, # Fixed to shared ASN
        })
...
for j in range(NUM_LEAVES):
    ...
    vars.update({
        ...
        "overlay_peers":      spine_loopbacks # Leaves peer with Spines
    })
